    ...
    commands: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            name: "color",
            description:
              "Color of the role in the format #RRGGBB without the #",
            required: false,
          },
        ],
      },
        ...
        options: [
          {
            ...
            name: "message",
            description:
              "The message you want to send when someone leaves the server",
            required: false,
          },
        ],
      },
        ...
        options: [
          {
            ...
            name: "message",
            description:
              "The message you want to send when someone joins the server",
            required: false,
          },
        ],
      },
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        name: "cardhighlow",
        description:
          "Guess if the next card will be higher or lower than the previous one",
        options: [],
      },
      {
        name: "cataas",
        ...
        options: [
          {
            ...
            name: "text",
            description:
              "The text you want to convert to speech (Default language is English)",
            required: true,
          },
          {
            choices: [
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            name: "options",
            description:
              "The options for your poll (use | to separate choices)",
            required: true,
          },
          {
            name: "multi",
    ...
    commands: [
      {
        name: "bobross",
        description:
          "Get a canvas painted by Bob Ross from the image you provide.",
        options: [
          {
            name: "image",
        ...
        options: [
          {
            name: "image",
            description:
              "The image to search for the exact scene. (Result may not be accurate depending on the image)",
            required: true,
            type: 11,
          },
        ],
